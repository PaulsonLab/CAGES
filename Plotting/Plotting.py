...
# Vanilla BO
xx1 = np.load('Results/Cartpole/cartpole_cost_EI.npy')
yy1 = (np.load('Results/Cartpole/cartpole_reward_EI.npy'))*-500
...
# Vanilla BO
xx1 = np.load('Results/OTL/OTL_cost_EI.npy')
yy1 = (np.load('Results/OTL/OTL_reward_EI.npy'))*-1
...
yy = (np.load('Results/Rosenbrock/Rosenbrock_reward_NewAcq.npy'))*-1
...
# Vanilla BO
xx1 = np.load('Results/Rosenbrock/Rosenbrock_cost_EI.npy')
yy1 = (np.load('Results/Rosenbrock/Rosenbrock_reward_EI.npy'))*-1
...
yy2 = -(np.load('Results/Rosenbrock/Rosenbrock_reward_GIBO.npy')*-1)
...
yy3 = -(np.load('Results/Rosenbrock/Rosenbrock_reward_ARS.npy')*-1)
