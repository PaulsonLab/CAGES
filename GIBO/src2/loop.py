...
def loop(
    ...
    optimizer = Optimizer(
        params_init, objective_w_counter, **optimizer_config, train_x_init = train_x_init, train_y_init = train_y_init, x_min = x_min, x_max = x_max
    )
    if max_iterations:
        ...
        while optimizer.func_eval_iteration < max_objective_calls:
            if verbose:
                print(
