...
from src.optimizers import (
    ...
    BayesianGradientAscent_custom1,
    BayesianGradientAscent_custom2,
    MPDOptimizer,
...
insertion_config = {
    "method": {
        ...
        "gibo_custom1": BayesianGradientAscent_custom1,
        "gibo_custom2": BayesianGradientAscent_custom2,
