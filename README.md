...
# Usage
We provide the code scripts for fitting the LVGP model and execution of different BO algorithm including Vanillo BO, GIBO, and CAGES. Augmented random search algorithm (ARS) is also provided.
